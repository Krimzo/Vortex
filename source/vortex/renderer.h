...
struct Renderer
{
    ...
    float4 background = kl::RGB(32, 32, 32);

    float4 default_light_color = kl::RGB(240, 215, 180);
    float4 default_dark_color = kl::RGB(180, 135, 100);
    float4 selected_light_color = kl::RGB(180, 235, 240);
    float4 selected_dark_color = kl::RGB(100, 180, 175);
    float4 last_played_light_color = kl::RGB(205, 240, 175);
    float4 last_played_dark_color = kl::RGB(145, 180, 95);
    float4 game_over_light_color = kl::RGB(240, 180, 175);
    float4 game_over_dark_color = kl::RGB(170, 100, 90);

...
vtx::UI::UI(Renderer& renderer) : renderer(renderer)
{
...
void vtx::UI::load_fonts(float dpi_scaling)
{
    ...
    atlas->AddFontFromFileTTF("fonts/roboto.ttf", 18 * dpi_scaling);
    atlas->Build();
}

void vtx::UI::load_colors()
{
    static constexpr float4 special_color = float4(1.0f);

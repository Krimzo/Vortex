...
vtx::Renderer::Renderer(Game& game) : game(game), m_render_texture(game.system.gpu)
{
    kl::GPU& gpu = game.system.gpu;

    m_screen_mesh = gpu.create_screen_mesh();
    m_shaders = gpu.create_shaders(kl::read_file_string("shaders/board_render.hlsl"));
    m_sampler_state = gpu.create_sampler_state(true, true);
    gpu.bind_blend_state(gpu.create_blend_state(true));

    w_pawn_icon = gpu.create_shader_view(gpu.create_texture(kl::Image("textures/W_PAWN.png")), nullptr);
    b_pawn_icon = gpu.create_shader_view(gpu.create_texture(kl::Image("textures/B_PAWN.png")), nullptr);
    w_knight_icon = gpu.create_shader_view(gpu.create_texture(kl::Image("textures/W_KNIGHT.png")), nullptr);
    b_knight_icon = gpu.create_shader_view(gpu.create_texture(kl::Image("textures/B_KNIGHT.png")), nullptr);
    w_bishop_icon = gpu.create_shader_view(gpu.create_texture(kl::Image("textures/W_BISHOP.png")), nullptr);
    b_bishop_icon = gpu.create_shader_view(gpu.create_texture(kl::Image("textures/B_BISHOP.png")), nullptr);
    w_rook_icon = gpu.create_shader_view(gpu.create_texture(kl::Image("textures/W_ROOK.png")), nullptr);
    b_rook_icon = gpu.create_shader_view(gpu.create_texture(kl::Image("textures/B_ROOK.png")), nullptr);
    w_queen_icon = gpu.create_shader_view(gpu.create_texture(kl::Image("textures/W_QUEEN.png")), nullptr);
    b_queen_icon = gpu.create_shader_view(gpu.create_texture(kl::Image("textures/B_QUEEN.png")), nullptr);
    w_king_icon = gpu.create_shader_view(gpu.create_texture(kl::Image("textures/W_KING.png")), nullptr);
    b_king_icon = gpu.create_shader_view(gpu.create_texture(kl::Image("textures/B_KING.png")), nullptr);
...
void vtx::Renderer::update()
{
    ...
    int2 render_size = game.system.viewport_size;
    resize(render_size);
...
void vtx::Renderer::resize(int2 new_size)
{

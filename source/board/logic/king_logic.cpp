...
void vtx::get_white_king_moves(Board const& board, int x, int y, std::function<bool(Board&)> const& board_iterator)
{
...
void vtx::get_black_king_moves(Board const& board, int x, int y, std::function<bool(Board&)> const& board_iterator)
{
    int from_index = get_index(x, y);
    Board temp_board;

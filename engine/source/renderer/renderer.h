...
namespace vtx {
    class renderer
    {
        ...
        kl::image w_pawn_icon   = {};
        kl::image w_knight_icon = {};
        kl::image w_bishop_icon = {};
        kl::image w_rook_icon   = {};
        kl::image w_queen_icon  = {};
        kl::image w_king_icon   = {};
        kl::image b_pawn_icon   = {};
        kl::image b_knight_icon = {};
        kl::image b_bishop_icon = {};
        kl::image b_rook_icon   = {};
        kl::image b_queen_icon  = {};
        kl::image b_king_icon   = {};
